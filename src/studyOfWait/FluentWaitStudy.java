...
public class FluentWaitStudy {
	...
	public static void main(String[] args) {
		...
		//Wait<WebDriver> q=new FluentWait<WebDriver>(driver).withTimeout(Duration.ofMillis(5000)).pollingEvery(Duration.ofMillis(5)).ignoring(NoSuchElementException.class);
